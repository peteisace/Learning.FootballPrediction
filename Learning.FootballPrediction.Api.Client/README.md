# IO.Swagger - the C# library for the Match API
...
------------ | ------------- | ------------- | -------------
*MatchApi* | [**MatchSavePost**](docs/MatchApi.md#matchsavepost) | **POST** /Match/save | 
...
## Documentation for Models
 ...
 - [Model.ClubRequest](docs/ClubRequest.md)
 - [Model.EventType](docs/EventType.md)
 - [Model.Match](docs/Match.md)
 - [Model.MatchEvent](docs/MatchEvent.md)
 - [Model.MatchEventRequest](docs/MatchEventRequest.md)
 - [Model.MatchRatings](docs/MatchRatings.md)
 - [Model.MatchRequest](docs/MatchRequest.md)
 - [Model.MeasurementType](docs/MeasurementType.md)
 - [Model.Player](docs/Player.md)
 - [Model.PlayerRequest](docs/PlayerRequest.md)
 - [Model.Position](docs/Position.md)
 - [Model.SquadMember](docs/SquadMember.md)
